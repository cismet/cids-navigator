...
public abstract class RmiReconnectorProxyFactory {
     ...
     * Das Wiederverbinden bei Verbindungsabbrüchen wird automatisch angestoßen.
     *
    ...
    /**
     * Erzeugt einen Dynamischen ReconnectorProxy mit graphischer Oberfläche
     ...
     * @return Dynamischer ReconnectorProxy des gewählten RMI-Dienstes
     */
    public static Remote createReconnectorProxyWithDialog(final Class<? extends Remote> serviceClass, final String serviceName) {
     ...
     * @return Dynamischer ReconnectorProxy des gewählten RMI-Dienstes
     */
    public static Remote createReconnectorProxyWithDialog(final Class<? extends Remote> serviceClass, final String serviceName, final JFrame parentFrame) {
        return createReconnectorProxy(serviceClass, serviceName, true, parentFrame);
    }

    /**
     * Erzeugt einen Dynamischen ReconnectorProxy mit oder ohne graphische
     * Oberfläche in Form eines Dialogs.
     *
     * @param serviceClass  Remote-Interface des zu erzeugenen Proxy
     * @param serviceName   Name des RMI-Dienstes
     ...
     * @return Dynamischer ReconnectorProxy des gewählten RMI-Dienstes
     */
    public static Remote createReconnectorProxy(final Class<? extends Remote> serviceClass, final String serviceName, final boolean useDialog, final JFrame parentFrame) {
        // RmiReconnector erzeugen
        RmiReconnector reconnector = new RmiReconnector(serviceClass, serviceName);
