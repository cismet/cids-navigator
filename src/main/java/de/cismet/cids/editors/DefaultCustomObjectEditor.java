 ...
 */
public class DefaultCustomObjectEditor extends javax.swing.JPanel implements DisposableCidsBeanStore, ConnectionContextStore {
    ...
    public synchronized void setCidsBean(final CidsBean cidsBean) {
        ...
        try {
            ...
            setMetaClassInformationToMetaClassStoreComponentsInBindingGroup(bindingGroup, cidsBean, getConnectionContext());
     ...
     */
    public static void setMetaClassInformationToMetaClassStoreComponentsInBindingGroup(final BindingGroup bindingGroup,
            final CidsBean cidsBean, final ConnectionContext connectionContext) {
        ...
        for (final Binding binding : bindings) {
            if (binding.getTargetObject() instanceof MetaClassStore) {
                ...
                try {
                    ...
                    final MetaClass foreignClass = CidsObjectEditorFactory.getMetaClass(domain, foreignClassId, connectionContext);
