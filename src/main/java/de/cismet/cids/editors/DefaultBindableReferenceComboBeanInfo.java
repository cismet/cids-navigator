...
public class DefaultBindableReferenceComboBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class , null ); // NOI18N
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_action] = new PropertyDescriptor ( "action", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getAction", "setAction" ); // NOI18N
            properties[PROPERTY_actionCommand] = new PropertyDescriptor ( "actionCommand", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getActionCommand", "setActionCommand" ); // NOI18N
            properties[PROPERTY_actionListeners] = new PropertyDescriptor ( "actionListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getActionListeners", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_bindingProperty] = new PropertyDescriptor ( "bindingProperty", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getBindingProperty", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_converter] = new PropertyDescriptor ( "converter", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getConverter", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_editor] = new PropertyDescriptor ( "editor", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getEditor", "setEditor" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_itemAt] = new IndexedPropertyDescriptor ( "itemAt", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, null, null, "getItemAt", null ); // NOI18N
            properties[PROPERTY_itemCount] = new PropertyDescriptor ( "itemCount", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getItemCount", null ); // NOI18N
            properties[PROPERTY_itemListeners] = new PropertyDescriptor ( "itemListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getItemListeners", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_keySelectionManager] = new PropertyDescriptor ( "keySelectionManager", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getKeySelectionManager", "setKeySelectionManager" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_lightWeightPopupEnabled] = new PropertyDescriptor ( "lightWeightPopupEnabled", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isLightWeightPopupEnabled", "setLightWeightPopupEnabled" ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumRowCount] = new PropertyDescriptor ( "maximumRowCount", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMaximumRowCount", "setMaximumRowCount" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_metaClass] = new PropertyDescriptor ( "metaClass", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMetaClass", "setMetaClass" ); // NOI18N
            properties[PROPERTY_metaClass].setPreferred ( true );
            properties[PROPERTY_metaClass].setBound ( true );
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_model] = new PropertyDescriptor ( "model", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getModel", "setModel" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_popupMenuListeners] = new PropertyDescriptor ( "popupMenuListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getPopupMenuListeners", null ); // NOI18N
            properties[PROPERTY_popupVisible] = new PropertyDescriptor ( "popupVisible", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isPopupVisible", "setPopupVisible" ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_prototypeDisplayValue] = new PropertyDescriptor ( "prototypeDisplayValue", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getPrototypeDisplayValue", "setPrototypeDisplayValue" ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_renderer] = new PropertyDescriptor ( "renderer", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getRenderer", "setRenderer" ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_selectedIndex] = new PropertyDescriptor ( "selectedIndex", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getSelectedIndex", "setSelectedIndex" ); // NOI18N
            properties[PROPERTY_selectedItem] = new PropertyDescriptor ( "selectedItem", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getSelectedItem", "setSelectedItem" ); // NOI18N
            properties[PROPERTY_selectedObjects] = new PropertyDescriptor ( "selectedObjects", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getSelectedObjects", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_validator] = new PropertyDescriptor ( "validator", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getValidator", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_actionListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "actionListener", java.awt.event.ActionListener.class, new String[] {"actionPerformed"}, "addActionListener", "removeActionListener" ); // NOI18N
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_itemListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "itemListener", java.awt.event.ItemListener.class, new String[] {"itemStateChanged"}, "addItemListener", "removeItemListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_popupMenuListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "popupMenuListener", javax.swing.event.PopupMenuListener.class, new String[] {"popupMenuWillBecomeVisible", "popupMenuWillBecomeInvisible", "popupMenuCanceled"}, "addPopupMenuListener", "removePopupMenuListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( de.cismet.cids.editors.DefaultBindableReferenceCombo.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
