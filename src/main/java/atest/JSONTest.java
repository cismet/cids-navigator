...
// }
//
            final CidsBean test = DevelopmentTools.createCidsBeanFromRMIConnectionOnLocalhost(
                    DOMAIN,
                    GROUP,
                    USER,
                    PASS,
            ...
            final String s = test.toJSONString();
            long dur = System.currentTimeMillis() - start;
            System.out.println("dur" + dur);
            final ObjectMapper om = new ObjectMapper();
            final CidsBean bb = om.readValue(s, CidsBean.class);

            start = System.currentTimeMillis();
            final String jackson = bb.toJSONString();
            dur = System.currentTimeMillis() - start;
            System.out.println("dur deserialize " + dur);
            FileUtils.writeStringToFile(new File(FOLDER + "a.json"), s);
            FileUtils.writeStringToFile(new File(FOLDER + "b.json"), s);
            LOG.fatal(bb.getMOString());
//            System.out.println("Länge der ersten Linie: "+
//            ((Geometry)bb.getProperty("linie.von.route.geom.geo_field")).getLength()
//                    );
        } catch (Throwable e) {
            e.printStackTrace();
        } finally {
     ...
     * @throws Exception DOCUMENT ME!
     */
// public static void check(final CidsBean b) throws Exception {
// long start = System.currentTimeMillis();
// final MetaClass mc = b.getMetaObject().getMetaClass();
// System.out.println("checkin " + mc.getTableName() + "/" + b.getPrimaryKeyValue() + " ....");
// final String s = b.toJSONString();
// final String sb = b.toJSONString(false);
// System.out.println("toJson: " + (System.currentTimeMillis() - start));
// FileUtils.writeStringToFile(new File(FOLDER + mc.getTableName() + "." + b.getPrimaryKeyValue() + ".json"),
// s);
// FileUtils.writeStringToFile(new File(FOLDER + mc.getTableName() + "." + b.getPrimaryKeyValue() + ".b.json"),
// sb);
// start = System.currentTimeMillis();
// final CidsBean newB = CidsBean.createNewCidsBeanFromJSON(s);
// System.out.println("erzeugen und fuellen: " + (System.currentTimeMillis() - start));
// start = System.currentTimeMillis();
// final String newS = newB.toJSONString();
// final String newSb = newB.toJSONString(false);
// System.out.println("toJson: " + (System.currentTimeMillis() - start));
//
// if (!s.equals(newS)) {
// System.out.println("Problem in (aktivierter Cache)" + mc.getTableName() + "/" + b.getPrimaryKeyValue());
...
// newS);
// } else {
// System.out.println("checked (aktivierter Cache)" + mc.getTableName() + "/" + b.getPrimaryKeyValue());
// }
// if (!sb.equals(newSb)) {
// System.out.println("Problem in (deaktivierter Cache)" + mc.getTableName() + "/" + b.getPrimaryKeyValue());
// FileUtils.writeStringToFile(new File(
// FOLDER
// + "x."
// + mc.getTableName()
...
// newS);
// } else {
// System.out.println("checked (deaktivierter Cache)" + mc.getTableName() + "/" + b.getPrimaryKeyValue());
// }
// }
//
// /**
