...
//        pRessort= new RessortPanel();
    ...
    private void initInfoNode(){
        vCatalogue = new View("Katalog",icoCatalogue,null);
        
        viewMap.addView("Katalog",vCatalogue);
        
        vObjectInfo= new View("Informationen zum Objekt",icoAttributetable,null);
        viewMap.addView("Informationene zum Objekt",vObjectInfo);
        
        
        vDescription= new View("Beschreibung",icoDescr,null);
        viewMap.addView("Beschreibung",vDescription);
        
        vEditor= new View("Attributeditor",icoAttributetable,null);
        viewMap.addView("Attributeditor",vEditor);
        
        vSearchResults= new View("Suchergebnisse",icoSearchresults,null);
