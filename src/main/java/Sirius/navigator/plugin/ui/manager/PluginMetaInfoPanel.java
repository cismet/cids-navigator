...
public class PluginMetaInfoPanel extends javax.swing.JPanel {
    ...
    {
        titleLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.panel.plugintitle"));
    ...
    {
        this.clear();
        titleLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.panel.methodtitle"));
    ...
    private void initComponents()
    {
        ...
        titleLabel.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.LOWERED));
        ...
        nameLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.name"));
        nameLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        versionLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.version"));
        versionLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        authorLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.author"));
        authorLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        copyrightLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.copyright"));
        copyrightLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        companyLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.company"));
        companyLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        contactLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.contact"));
        contactLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        homepageLabel.setText(ResourceManager.getManager().getString("plugin.metainfo.homepage"));
        homepageLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        descriptionPanel.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.TitledBorder(ResourceManager.getManager().getString("plugin.metainfo.description")), new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 2, 2, 2))));
