...
/**
 * Basisklasse aller simplen und komplexen Editoren.<p>
 * Die Methoden stopEditing() und cancelEditing sollten<br>
 ...
 * Ein geeignter Listener sollte auf diese Ereginisse reagieren und 
 * dementsprechend die Werte der untergeordneten Objekte setzten.
 *
 * @author  Pascal
 */
public interface BasicEditor extends BasicContainer
{
    ...
    /**
     * Setzt eine Eigenschaft des Editors, z.B. die Sprache.<p>
     * Implementierende Klassen sollten zuerst super.setProperty()
     * aufrufen, der return Wert gibt dann an, ob die Eigenschaft bereits der
     * Superklasse bekannt war und schon gesetzt wurde.
     *
    ...
    /**
     * Fragt eine Eigenschaft des Editors ab.<p>
     * z.B. die Sprache
     *
    ...
    /**
     * Gibt an, ob der Wert durch den Editor ver\u00E4ndert wurde.<p>
     * Nach dem Aufruf dieser Methode, solle das changed flag automatisch auf 
     * false zur\u00FCckgesetzt werden.<br>.
     * Das changed flag sollte in der Methode stopEditing() auf true gesetzt 
     * werden, wenn getComponentValue() einen neuen Wert liefert.
     *
     ...
     * Das changed flag sollte in der Methode stopEditing() auf true gesetzt 
     * werden, wenn getComponentValue() einen neuen Wert liefert.
     * Das changed flag sollte durch den parent editor automatisch auf false 
     * gesetzt werden (im editor Listener).<br>.
     *
     * @return true, wenn sich der Wert ge\u00E4ndert hat
     */
    ...
    /**
     * Gibt an, da\u00DF ein neuer Wert durch den Editor hinzugef\u00FCgt wurde.<p> 
     * Wird nur abgefragt, wenn isChanged() true liefert. Der parent Editor 
     * sollte das alte Objekt zur id des child Editors entfernen, das neue Objekt 
     * unter einer neuen negativen is hinzuf\u00FCgen und dem Editor diese neue id 
     * zuweisen.<br>
