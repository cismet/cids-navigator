...
/**
 * Ein Options Dialog, ueber den alle Einstellungen des Grids, der ControlPoints, der Splines, etc.
 * bequem eingestellt werden koennen. Der OptionsDialog besitzt eine Vorschaufunktion und arbeitet
 * mit eine Kopie des GridModels und des ControlModels.
 *
...
public class OptionsDialog extends JDialog implements ActionListener
{
    ...
    private JSpinner maxConnectionsSpinner, maxSearchResultsSpinner;
    private JRadioButton optimizeLayout, optimizeSpeed;
    ...
    private JRadioButton sortAscendingOption, sortDescendingOption;
    ...
    //private JComboBox plugInBox;
    
        /*public OptionsDialog(NavigatorModel navigatorModel, PlugInModel plugInModel)
        {
                //_TA_super(new JFrame(), "Erweiterte Optionen", true);
                super(new JFrame(), this.resources.getString("STL@moreOptions") , true);
    ...
    // DEPRECATED ---------------------------------------------------------------
         ...
         *@deprecated
         */
        /*public OptionsDialog(NavigatorModel navigatorModel, ISFloatingFrameModel isFloatingFrameModel)
        {
                //_TA_super(new JFrame(), "Erweiterte Optionen", true);
                super(new JFrame(), this.resources.getString("STL@moreOptions") , true);
         
                this.navigatorModel = navigatorModel;
                this.isFloatingFrameModel = isFloatingFrameModel;
                initOptionsDialog();
        }*/
         ...
         */
    // !!! MANU_NAV Start !!!
    // Zur Verwendung von ISDS!!!
    //[ISDS PD 12062002]
        /*public OptionsDialog(NavigatorModel navigatorModel, ISFloatingFrameModel isFloatingFrameModel, ISDSFloatingFrameModel isdsFloatingFrameModel )
        {
                //_TA_super(new JFrame(), "Erweiterte Optionen", true);
                super(new JFrame(), this.resources.getString("STL@moreOptions") , true);
                ...
                this.navigatorModel = navigatorModel;
                this.isFloatingFrameModel = isFloatingFrameModel;
                this.isdsFloatingFrameModel = isdsFloatingFrameModel;
                initOptionsDialog();
        }*/
    // !!! MANU_NAV Ende !!!
    // DEPRECATED ---------------------------------------------------------------
    ...
    private void initOptionsDialog()
    {
        ...
        /*//[ISDS PD 12062002]	if ( this.isdsFloatingFrameModel != null )
                {
                                buildISFloatingFramePanel();
                                //_TA_tabbedPane.addTab("Sicad IMS Client", isFloatingFramePanel);
...
/*	if ( this.isdsFloatingFrameModel != null )
    ...
    private void buildNavigatorPanel()
    {
        ...
        gbc2.weightx = 0.0;
        gbc2.weighty = 0.0;
        //navMaxConnectionsBox = new SingleLineListBox(NavigatorModel.MIN_SERVER_THREADS, NavigatorModel.MAX_SERVER_THREADS, 1);
        maxConnectionsSpinner = new JSpinner(new SpinnerNumberModel(PropertyManager.MIN_SERVER_THREADS, PropertyManager.MIN_SERVER_THREADS, PropertyManager.MAX_SERVER_THREADS, 1));
        navigatorServerPanel.add(maxConnectionsSpinner, gbc2);
        
        gbc2.insets = new Insets(0, 0, 0, 0);
        gbc2.gridy++;
        //navMaxSearchResultBox = new SingleLineListBox(NavigatorModel.MIN_SEARCH_RESULTS, NavigatorModel.MAX_SEARCH_RESULTS, 1);
        maxSearchResultsSpinner = new JSpinner(new SpinnerNumberModel(PropertyManager.MIN_SEARCH_RESULTS, PropertyManager.MIN_SEARCH_RESULTS, PropertyManager.MAX_SEARCH_RESULTS, 10));
        ...
        gbc2.weightx = 1.0;
        gbc2.weighty = 1.0;
        //navLookAndFeelBox = new JComboBox(new String[]{PropertyManager.METAL, PropertyManager.WINDOWS, PropertyManager.MOTIF});
        //navLookAndFeelBox = new JComboBox(new String[]{navigatorModel.METAL, navigatorModel.WINDOWS, navigatorModel.MOTIF});
        navLookAndFeelBox = new JComboBox(new java.util.Vector(Sirius.navigator.ui.LAFManager.getManager().getInstalledLookAndFeelNames()));
    ...
    private void updateNavigatorPanel()
    {
        ...
        ((SpinnerNumberModel)maxSearchResultsSpinner.getModel()).setValue(new Integer(properties.getMaxSearchResults()));
    ...
    private void updateNavigatorModel()
    {
        ...
        // !!! MANU_NAV Start !!!
        //[ISDS PD 12062002]
        //	if (isdsFloatingFrameModel != null )
        //		isdsFloatingFrameModel.setCallServerProperties( (String)isdsCallServerIPTF.getText(), (String)isdsCallServerPortTF.getText(), (String)isdsCallServerNameTF.getText() );
        // !!! MANU_NAV Ende !!!
        ...
        /*private void buildPlugInPanel()
        {
                ...
                isFloatingFramePanel = new JPanel(new GridLayout(1,1,5,5));
                isFloatingFramePanel.setBorder(new CompoundBorder(new EmptyBorder(10,10,10,10), new EtchedBorder()));
         
                String isfString = new String("<html>"); //<center><h2>IMS Parameter:</h2>");
                String[] isfParameter = isFloatingFrameModel.toStringArray();
         
                for(int i = 0; i < isfParameter.length; i++)
                        isfString += ("<p>" + isfParameter[i] + "</p>");
         
                isfString += "</html>";
         
                JLabel isfLabel = new JLabel(isfString);
                isfLabel.setBorder(new EmptyBorder(5,5,5,5));
                isFloatingFramePanel.add(isfLabel);
        }*/
    ...
    //!!! MANU_NAV Start !!!
        ...
        {
                GridBagLayout isds_gbl = new GridBagLayout();
                GridBagConstraints isds_gbc = new GridBagConstraints();
                isdsFloatingFramePanel = new JPanel( isds_gbl );
                isdsFloatingFramePanel.setBorder( new CompoundBorder( new TitledBorder(null, "ISDS Options", TitledBorder.LEFT, TitledBorder.TOP), new EmptyBorder(2,5,5,5) ) );
         
         
                // LABELS
         
                // bottom left right top
                isds_gbc.insets = new Insets(0, 0, 7, 5);
                isds_gbc.anchor = GridBagConstraints.NORTHWEST;
                isds_gbc.fill = GridBagConstraints.NORTH;
         
                isds_gbc.gridheight = 1;
                isds_gbc.gridwidth = 1;
                isds_gbc.weightx = 0.0;
                isds_gbc.weighty = 0.0;
                isds_gbc.gridx = 0;
                isds_gbc.gridy = 0;
         
                //isdsFloatingFramePanel.add(new JLabel(this.resources.getString("STL@callServerIP")), isds_gbc);
                isdsFloatingFramePanel.add(new JLabel(this.resources.getString("STL@callServerIP")), isds_gbc );
                isds_gbc.gridy++;
                isdsFloatingFramePanel.add(new JLabel("Port:"), isds_gbc);
                isds_gbc.gridy++;
                isdsFloatingFramePanel.add(new JLabel("Servername:"), isds_gbc);
                isds_gbc.gridy++;
                ...
                isdsCallServerIPTF = new JTextField(9);
                //[ISDS PD 12062002]isdsCallServerIPTF.setText( (String)isdsFloatingFrameModel.getCallServerIP() );
                isdsFloatingFramePanel.add(isdsCallServerIPTF, isds_gbc);
                isds_gbc.gridy++;
                isdsCallServerPortTF = new JTextField(9);
                //[ISDS PD 12062002]isdsCallServerPortTF.setText( (String)isdsFloatingFrameModel.getCallServerPort() );
                isdsFloatingFramePanel.add(isdsCallServerPortTF, isds_gbc);
                isds_gbc.gridy++;
                isdsCallServerNameTF = new JTextField(9);
                //[ISDS PD 12062002]isdsCallServerNameTF.setText( (String)isdsFloatingFrameModel.getCallServerName() );
