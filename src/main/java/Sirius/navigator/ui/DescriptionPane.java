        ...
        worker = new javax.swing.SwingWorker<SelfDisposingPanel, Void>() {
                ...
                protected SelfDisposingPanel doInBackground() throws Exception {
                    ...
                    if (isNoDescriptionRenderer) {
                        ...
                        if (jComp instanceof InitialisationLocker) {
                            final InitialisationLocker locker = (InitialisationLocker)jComp;
                            if (!locker.getInitialisationLatch().await(15, TimeUnit.SECONDS)) {
